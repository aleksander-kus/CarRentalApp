...
namespace CarRental.Infrastructure.Test.Util
{
    public class CarFilteringUtilTest
    {
        ...
        public void ShouldReturnAllCarsMatchingFilterAsync(CarListFilter filter, string[] expectedCarIds)
        {
        ...
        public static IEnumerable<object[]> TestFilters =>
            new List<object[]>
            {
                ...
                new object[] {new CarListFilter {ProductionYearMin = 2100}, Array.Empty<string>()},
                new object[] {new CarListFilter {CapacityMin = 11}, Array.Empty<string>()},
                new object[]
                {
